...
public class LibraryChunkProvider implements IChunkGenerator {
    ...
    protected static final IBlockState OTHER_BLOCK1 = Blocks.AIR.getDefaultState();
    protected static final IBlockState OTHER_BLOCK2 = Blocks.AIR.getDefaultState();
    ...
    public LibraryChunkProvider(World world, boolean generate, long seed) {
        this.world = world;
...
//        WorldGenCustomStructures.generateInWorld(this.rand, 0, 0, this.world);
